...
WORKFLOWS:
    development (default) - Full chain: start → scope → spec → plan → execute → validate → publish → finalize → wrap
    spike (--spike)       - Light chain: start → scope → plan → execute → wrap (no PR)
